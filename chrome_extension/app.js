...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scriptsContainersApp = __webpack_require__(158);

	var _scriptsContainersApp2 = _interopRequireDefault(_scriptsContainersApp);
	...
	_react2['default'].render(_react2['default'].createElement(_scriptsContainersApp2['default'], { show: show }), document.querySelector('.App'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PumgranaApp = __webpack_require__(188);

	var _PumgranaApp2 = _interopRequireDefault(_PumgranaApp);

	var reducer = (0, _redux.combineReducers)(stores);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                { store: store },
	                function () {
	                    return _react2['default'].createElement(_PumgranaApp2['default'], null);
	                }
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBindActionCreators = __webpack_require__(160);
	...
	var _utilsComposeMiddleware = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _composeMiddleware = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvideDecorator = __webpack_require__(175);

	var _createProvideDecorator2 = _interopRequireDefault(_createProvideDecorator);

	var _createConnector = __webpack_require__(177);

	var _createConnector2 = _interopRequireDefault(_createConnector);

	var _createConnectDecorator = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsGetDisplayName = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqualScalar = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.pages = _interopRequire(_pages);

	var _relatedContent = __webpack_require__(185);

	exports.related_content = _interopRequire(_relatedContent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = related_content;

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

	var _constantsActionTypes = __webpack_require__(186);

	var _utilsApiTs = __webpack_require__(187);

	var _utilsApiTs2 = _interopRequireDefault(_utilsApiTs);
	...
	function related_content(state, action) {
	    if (state === undefined) state = initialState;

	    switch (action.type) {
	        case _constantsActionTypes.BOOKMARK_ITEM:
	            return state.map(function (item) {
	                return item.id === action.id ? _extends({}, item, { bookmarked: !item.bookmarked }) : item;
	            });

	        case _constantsActionTypes.VISIT_ITEM:
	            return state.map(function (item) {
	                return item.id === action.id ? _extends({}, item, { visited: true }) : item;
	            });
...
/***/ function(module, exports) {
	...
	var BOOKMARK_PAGE = 'BOOKMARK_PAGE';
	exports.BOOKMARK_PAGE = BOOKMARK_PAGE;
	var BOOKMARK_ITEM = 'BOOKMARK_ITEM';
	exports.BOOKMARK_ITEM = BOOKMARK_ITEM;
	var VISIT_ITEM = 'VISIT_ITEM';
	exports.VISIT_ITEM = VISIT_ITEM;
	var LOAD_MORE_RELATED_CONTENT = 'LOAD_MORE_RELATED_CONTENT';
	exports.LOAD_MORE_RELATED_CONTENT = LOAD_MORE_RELATED_CONTENT;
...
/***/ function(module, exports) {
	...
	var API;
	(function (API) {
	    function DoAjaxCall(prefix, param) {
	        var NetworkInterface = new XMLHttpRequest();
	    ...
	    API.DoAjaxCall = DoAjaxCall;
	    function GetLinksFromContent(uri) {
	        return DoAjaxCall('linkedcontent/from_content/', uri).links;
	    }
	    API.GetLinksFromContent = GetLinksFromContent;
	    function GetLinksFromResearch(uri, input) {
	        return DoAjaxCall('linkedcontent/search/' + encodeURIComponent(uri), input).links;
	    }
	    API.GetLinksFromResearch = GetLinksFromResearch;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsResultatActions = __webpack_require__(189);

	var LinkActions = _interopRequireWildcard(_actionsResultatActions);

	var _Container = __webpack_require__(190);

	var _Container2 = _interopRequireDefault(_Container);

	var PumgranaApp = (function (_Component) {
	    _inherits(PumgranaApp, _Component);

	    function PumgranaApp() {
	        _classCallCheck(this, _PumgranaApp);

	        _get(Object.getPrototypeOf(_PumgranaApp.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(PumgranaApp, [{
	        key: 'render',
	        ...
	        value: function render() {
	            ...
	            var related_content = _props.related_content;

	            var actions = (0, _redux.bindActionCreators)(LinkActions, this.props.dispatch);
	         ...
	         *
	         */
	        value: { page: {}, related_content: [] },
	        enumerable: true
	    }, {
	        key: 'propTypes',
	        value: {
	            page: _react2['default'].PropTypes.object.isRequired,
	            related_content: _react2['default'].PropTypes.array.isRequired
	        },
	        enumerable: true
	    }]);

	    var _PumgranaApp = PumgranaApp;
	    PumgranaApp = (0, _reactRedux.connect)(function (state) {
	        return {
	            pages: state.pages,
	            related_content: state.related_content
	        };
	    })(PumgranaApp) || PumgranaApp;
	    return PumgranaApp;
	})(_react.Component);

	exports['default'] = PumgranaApp;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _View = __webpack_require__(195);

	var _View2 = _interopRequireDefault(_View);

	var _ViewBookmarks = __webpack_require__(212);

	var _ViewBookmarks2 = _interopRequireDefault(_ViewBookmarks);
	...
	var Container = (function (_Component) {
	    ...
	    _createClass(Container, [{
	        ...
	        value: function render() {
	            ...
	            var current_page = _state.current_page;
	            var bookmarks_content = _state.bookmarks_content;
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    pages.map(function (page, i) {
	                        ...
	                        return _react2['default'].createElement(_View2['default'], { page: page,
	                            related_content: related_content.filter(function (item) {
	                    ...
	                    _react2['default'].createElement(_ViewBookmarks2['default'], {
	                        related_content: related_content,
	                        show: bookmarks_content,
	                        actions: actions })
	                ),
	                _react2['default'].createElement(_Footer2['default'], { related_content: related_content, goToBookmarks: this.goToBookmarks.bind(this) })
	            );
	        }
	    }], [{
	        key: 'defaultProps',
	         ...
	         *
	         */
	        value: { pages: [], related_content: [], actions: {} },
	        enumerable: true
	    }, {
	        key: 'propTypes',
	        value: {
	...
	var View = (function (_Component) {
	    ...
	    _createClass(View, [{
	        ...
	        value: function render() {
	            ...
	            var lastPageId = _props.lastPageId;
	            var goTo = _props.goTo;
	            var search = this.state.search;

	            return _react2['default'].createElement(
	                'div',
	                { className: 'View View-' + position },
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(_SearchBar2['default'], { handleSearch: this.handleSearch.bind(this) }),
	        ...
	        value: {
	            page: _react2['default'].PropTypes.object.isRequired,
	            related_content: _react2['default'].PropTypes.object.isRequired,
	            actions: _react2['default'].PropTypes.object.isRequired,
	            position: _react2['default'].PropTypes.string.isRequired,
	            lastPageId: _react2['default'].PropTypes.number.isRequired,
	            goTo: _react2['default'].PropTypes.func.isRequired
	        },
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: "Header" },
	                _react2['default'].createElement('a', { role: "button", onClick: this._back.bind(this), ref: "back", 'aria-label': "Go back", href: "#/", className: (0, _classnames2['default'])("Header_back", {
	                        "is-active": page.id != 0
	                    }) }),
	                _react2['default'].createElement(
	                    'span',
	                    { className: "Header_url" },
	                    page.website
	                ),
	                _react2['default'].createElement(
	                    'span',
	                ...
	                _react2['default'].createElement('a', { role: "button", onClick: this._next.bind(this), ref: "next", 'aria-label': "Go next", href: "#/", className: (0, _classnames2['default'])("Header_next", {
	         ...
	         *
	         */
	        value: { page: {}, lastPageId: 0, goTo: function goTo() {} },
	        enumerable: true
	    }, {
	        key: 'propTypes',
	        value: {
	    ...
	    _createClass(SearchBar, [{
	        ...
	        value: function _onChange() {
	            ...
	            var timer = setTimeout(function () {
	                _this.props.handleSearch(_this.refs.searchBarInput.getDOMNode().value);
	            }, 1300);
	        }
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { type: "text", ref: "searchBarInput", placeholder: "Search...", className: "SearchBar", onKeyDown: this._onChange.bind(this) })
	            );
	        }
	    }], [{
	        key: 'propTypes',
	...
	var List = (function (_Component) {
	    ...
	    _createClass(List, [{
	        ...
	        value: function render() {
	            var _props = this.props;
	            var related_content = _props.related_content;
	            var bookmarkItem = _props.bookmarkItem;
	            var visitItem = _props.visitItem;
	            ...
	            if (loadMore) {
	                loader = _react2['default'].createElement(
	                    'button',
	                    {
	                        ...
	                        className: (0, _classnames2['default'])("List_loadMore", {
	                            "is-active": loading
	                        }) },
	            ...
	            if (related_content.length == 0) {
	                related_content = _react2['default'].createElement(
	                    'div',
	                    { className: "List-empty" },
	                    'No resultats found'
	                );
	            } else {
	                related_content = related_content.map(function (item, i) {
	                    return _react2['default'].createElement(
	                        'div',
	                        null,
	                        _react2['default'].createElement(_Item2['default'], { bookmarkItem: bookmarkItem, visitItem: visitItem, key: i, item: item })
	                    );
	                });
	            }
	        ...
	        value: {
	            related_content: [],
	            bookmarkItem: function bookmarkItem() {},
	            visitItem: function visitItem() {},
	            loadMore: false
	        },
	        enumerable: true
	    }, {
	        ...
	        value: {
	            related_content: _react2['default'].PropTypes.array.isRequired,
	            bookmarkItem: _react2['default'].PropTypes.func.isRequired,
	            visitItem: _react2['default'].PropTypes.func.isRequired,
	            loadMore: _react2['default'].PropTypes.bool.isRequired
	        },
	...
	var Item = (function (_Component) {
	    ...
	    _createClass(Item, [{
	        ...
	        value: function render() {
	            ...
	            var visited = _props$item.visited;
	            var link = _props$item.link;
	            var bookmarked = _props$item.bookmarked;
	            var website = _props$item.website;
	            var title = _props$item.title;
	            var description = _props$item.description;
	            var tags = _props$item.tags;
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'svg',
	                    { onClick: this.handleBookmark.bind(this), className: (0, _classnames2['default'])('Item_bookmark', {
	                    ...
	                    _react2['default'].createElement('path', { d: "M3.437 1h8.126L14 3.45V19l-4.063-3.273L5.875 19V3.45L3.437 1 1 3.45V9.18h4.875", stroke: "#DCDCDC", fill: "#FFFFFF", strokeLinecap: "round", strokeLinejoin: "round", fillRule: "evenodd" })
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { onClick: this.handleVisite.bind(this) },
	                    _react2['default'].createElement(
	                        'span',
	                        { className: "Item_url" },
	                        website
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewBookmarks = (function (_Component) {
	    _inherits(ViewBookmarks, _Component);

	    function ViewBookmarks() {
	        _classCallCheck(this, ViewBookmarks);

	        _get(Object.getPrototypeOf(ViewBookmarks.prototype), 'constructor', this).apply(this, arguments);

	        this.state = {};
	    }

	    _createClass(ViewBookmarks, [{
	        key: 'render',
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: (0, _classnames2['default'])("View ViewBookmarks", {
	                        "is-showed": show
	                    }) },
	                _react2['default'].createElement(
	                    'div',
	         ...
	         *
	         */
	        value: { related_content: {}, actions: {}, show: false },
	        enumerable: true
	    }, {
	        key: 'propTypes',
	        value: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = (function () {
	    ...
	    _createClass(Footer, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var related_content = this.props.related_content;
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'a',
	                    { className: (0, _classnames2['default'])("Footer_viewBookmarks", {
	                            "is-active": related_content.filter(function (item) {
	                                return item.bookmarked === true;
	                            }).length
	                        }), title: "View all your bookmarks", role: "button", onClick: this._onClick.bind(this) },
	                    _react2['default'].createElement(
	                        'svg',
	                        { width: "15", height: "20", viewBox: "0 0 15 20", xmlns: "http://www.w3.org/2000/svg" },
	                        _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement('path', { d: "M3.437 1h8.126L14 3.45V19l-4.063-3.273L5.875 19V3.45L3.437 1 1 3.45V9.18h4.875", stroke: "#D2D2D2", fill: "#EBEBEB", strokeLinecap: "round", strokeLinejoin: "round", fillRule: "evenodd" })
	                    )
	                ),
	                _react2['default'].createElement('a', { className: "Footer_website", href: "#/pumgrana/website", title: "Go to Pumgrana website" })
	            );
	        }
	    }], [{
	        key: 'defaultProps',
	        ...
	        value: {
	            related_content: {},
	            goToBookmarks: function goToBookmarks() {}
	        },
	        enumerable: true
	    }, {
	        key: 'propTypes',
	        value: {
	            related_content: _react2['default'].PropTypes.object.isRequired,
	            goToBookmarks: _react2['default'].PropTypes.func.isRequired
	        },
	        enumerable: true
	    }]);
